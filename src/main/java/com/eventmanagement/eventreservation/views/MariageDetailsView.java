...
@Route("mariage-details")
public class MariageDetailsView extends Div {
    
    public MariageDetailsView() {
        setSizeFull();
        getStyle()
            .set("margin", "0")
            .set("padding", "0")
    ...
    private Div createHeroSection() {
        ...
        hero.getStyle()
            .set("width", "100%")
            .set("height", "400px")
            .set("background-image", "url('images/mariage.jpg')")
    ...
    private Div createDetailsSection() {
        ...
        // Introduction
        H3 intro = new H3("Un jour unique, une célébration inoubliable");
        intro.getStyle()
            .set("font-family", "'Playfair Display', 'Georgia', serif")
            .set("font-size", "2rem")
            .set("color", "#c9a961")
        ...
        Paragraph description = new Paragraph(
            "Votre mariage est le jour le plus important de votre vie. Chez Eventia, nous comprenons " +
            "l'importance de chaque détail et nous nous engageons à créer une expérience unique qui " +
            "reflète votre amour et votre personnalité. De la cérémonie à la réception, nous orchestrons " +
            "chaque moment avec passion et professionnalisme."
        );
        ...
        services.add(
            createServiceItem("🎊", "Décoration personnalisée", "Thème sur mesure selon vos envies"),
            createServiceItem("🍽️", "Traiteur gastronomique", "Menu raffiné et adapté à vos goûts"),
            createServiceItem("📸", "Photographe professionnel", "Immortalisez chaque instant magique"),
            createServiceItem("🎵", "Animation musicale", "DJ et orchestre pour une ambiance parfaite")
        );
        
        // Bouton de réservation
        Button bookButton = new Button("Réserver une consultation gratuite");
        bookButton.getStyle()
