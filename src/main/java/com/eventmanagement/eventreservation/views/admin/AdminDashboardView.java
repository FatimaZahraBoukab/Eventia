...
public class AdminDashboardView extends Div {
    ...
    private HorizontalLayout createStatsCards() {
        ...
        layout.add(
            createStatCard("Templates", "5", VaadinIcon.FILE_TEXT, "#5B9BD5"),
            createStatCard("Utilisateurs", String.valueOf(totalUsers), VaadinIcon.USERS, "#C8A050"),
            createStatCard("Utilisateurs actifs", String.valueOf(activeUsers), VaadinIcon.CHECK_CIRCLE, "#70AD47"),
            createStatCard("Utilisateurs inactifs", String.valueOf(inactiveUsers), VaadinIcon.CLOSE_CIRCLE, "#ED7D31")
        );
