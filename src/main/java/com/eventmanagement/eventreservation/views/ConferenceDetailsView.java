...
public class ConferenceDetailsView extends Div {
    ...
    private Div createHeroSection() {
        ...
        hero.getStyle()
            .set("width", "100%")
            .set("height", "400px")
            .set("background-image", "url('images/conference.jpg')")
        ...
        H1 title = new H1("Conférence & Séminaire");
        title.getStyle()
    ...
    private Div createDetailsSection() {
        ...
        H3 intro = new H3("Des événements professionnels d'excellence");
        intro.getStyle()
            .set("font-family", "'Playfair Display', 'Georgia', serif")
            .set("font-size", "2rem")
            .set("color", "#c9a961")
        ...
        Paragraph description = new Paragraph(
            "Organisez vos conférences et séminaires d'entreprise avec Eventia. Nous créons des " +
            "espaces propices à l'échange et à l'innovation, en combinant professionnalisme et " +
            "créativité. De la logistique à l'animation, nous gérons chaque aspect pour garantir " +
            "le succès de votre événement professionnel."
        );
        ...
        services.add(
            createServiceItem("🏢", "Espaces modulables", "Salles équipées et adaptées à vos besoins"),
            createServiceItem("🎤", "Équipement audiovisuel", "Technologie de pointe pour vos présentations"),
            createServiceItem("☕", "Restauration professionnelle", "Pauses café et déjeuners d'affaires"),
            createServiceItem("📋", "Coordination complète", "Gestion de A à Z de votre événement")
        );
        
        Button bookButton = new Button("Demander un devis personnalisé");
        bookButton.getStyle()
