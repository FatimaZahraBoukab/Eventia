...
public class OrganizerSidebar extends Div {
    
    private Span timeLabel;
    private Span dateLabel;
    
    public OrganizerSidebar(String currentRoute) {
        addClassName("organizer-sidebar");
        getStyle()
            .set("width", "260px")
        ...
        menu.add(
            createMenuItem(VaadinIcon.DASHBOARD, "Tableau de bord", "organizer/dashboard", currentRoute.equals("organizer/dashboard")),
            createMenuItem(VaadinIcon.CALENDAR, "Événements", "organizer/events", currentRoute.equals("organizer/events")),
            createMenuItem(VaadinIcon.TICKET, "Réservations", "organizer/reservations", currentRoute.equals("organizer/reservations")),
            createMenuItem(VaadinIcon.USER, "Mon Profil", "organizer/profile", currentRoute.equals("organizer/profile"))
        );
