...
public class OrganizerProfileView extends Div {
    ...
    public OrganizerProfileView(@Autowired UserService userService) {
        ...
        OrganizerSidebar sidebar = new OrganizerSidebar("organizer/profile");
    ...
    private Div createProfileCard() {
        ...
        String initials = currentUser != null && currentUser.getFullName() != null ? 
            currentUser.getFullName().substring(0, 1).toUpperCase() : "O";
        avatar.add(new Span(initials));
        
        H3 name = new H3(currentUser != null ? currentUser.getFullName() : "Organisateur");
        name.getStyle()
